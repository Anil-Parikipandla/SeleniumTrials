...
public class BookAFlightTest {
	...
	public void UserCanBookAFlight() throws InterruptedException{
		Runner.driver.get(APPLICATION_URL);
		
		String actualPageTitle = Runner.driver.getTitle();
		Assert.assertEquals( actualPageTitle,expectedPageTitle,"Application did not match the expected");
		System.out.println("Application Opened successfully!");
		
		originTextBox = Runner.driver.findElement(By.xpath("//input[@id='flt_origin_text']"));
		CustomWaits.waitforElement(Runner.driver, originTextBox, 2);
		...
		destinationTextBox = Runner.driver.findElement(By.xpath("//input[@id='flt_destin_text']"));
		CustomWaits.waitforElement(Runner.driver, destinationTextBox, 2);
		...
		actualNoOfAdults = Runner.driver.findElement(By.xpath("//div[@id='fltHiddenFormPart']//div/label[contains(text(),'Adults')]/ancestor::div/div[@class='amout-line']//a[@role='button']")).getText();
		...
		NoOfChildren = Runner.driver.findElement(By.xpath("//div[@id='fltHiddenFormPart']//div/label[contains(text(),'Children')]/ancestor::div/div[@class='amout-line']//div/div[@class='clicker  plus-amount-light']"));
		CustomWaits.waitforElement(Runner.driver, NoOfChildren, 2);
		NoOfChildren.click();
		
		actualNoOfChildren = Runner.driver.findElement(By.xpath("//div[@id='fltHiddenFormPart']//div/label[contains(text(),'Children')]/ancestor::div/div[@class='amout-line']//a[@role='button']")).getText();
		...
		Runner.driver.findElement(By.xpath("//div/button[@type='submit']/span[contains(text(),'Find flights & fares')]")).click();
		Runner.driver.findElement(By.xpath("//h2[contains(text(),'Flights and ticket types')]")).getText();
